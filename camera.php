...
<div><div class="section">
						...
						<div class="products-tabs">
							<div id="tab1" class="tab-pane active">
								<div class="products-slick">
									<?php
									$produk = mysqli_query($conn, "SELECT * FROM products WHERE kategori = 'KAMERA'");

									while($row = mysqli_fetch_assoc($produk)) {
									?>
									<div class="product">
										<div class="product-img">
											<img src="<?= ($row['id'] == 10) ? './img/productacc05.png' : $row['gambar']; ?>" alt="">
  ...
  <input type="hidden" name="redirect" value="camera.php">
						...
						<div class="products-tabs">
							<div id="tab1" class="tab-pane active">
								<div class="products-slick" >
									...
									<div class="product">
										<div class="product-img">
											<img src="<?= ($row['id'] == 11) ? './img/productacc06.png' : $row['gambar']; ?>" alt="">
											<div class="product-label">
												<?php if($row['is_sale']) echo '<span class="sale">-30%</span>'; ?>
												<?php if($row['is_new']) echo '<span class="new">NEW</span>'; ?>
											</div>
						...
						<div class="products-tabs">
							<div id="tab1" class="tab-pane active">
								<div class="products-slick" >
									...
									<div class="product">
										<div class="product-img">
											<img src="<?= ($row['id'] == 12) ? './img/productacc07.png' : $row['gambar']; ?>" alt="">
											<div class="product-label">
												<?php if($row['is_sale']) echo '<span class="sale">-30%</span>'; ?>
												<?php if($row['is_new']) echo '<span class="new">NEW</span>'; ?>
											</div>
