...
<div><div class="section">
						...
						<div class="products-tabs">
							<div id="tab1" class="tab-pane active">
								<div class="products-slick">
									<?php
									$produk = mysqli_query($conn, "SELECT * FROM products WHERE kategori = 'Aksesoris'");

									while($row = mysqli_fetch_assoc($produk)) {
									?>
									<div class="product">
										<div class="product-img">
											<img src="<?= ($row['id'] == 7) ? './img/productacc02.png' : $row['gambar']; ?>" alt="">
  ...
  <input type="hidden" name="redirect" value="accessories.php">
						...
						<div class="products-tabs">
							<div id="tab1" class="tab-pane active">
								<div class="products-slick" >
									...
									<div class="product">
										<div class="product-img">
											<img src="<?= ($row['id'] == 8) ? './img/productacc03.png' : $row['gambar']; ?>" alt="">
											<div class="product-label">
												<?php if($row['is_sale']) echo '<span class="sale">-30%</span>'; ?>
												<?php if($row['is_new']) echo '<span class="new">NEW</span>'; ?>
											</div>
						...
						<div class="products-tabs">
							<div id="tab1" class="tab-pane active">
								<div class="products-slick" >
									...
									<div class="product">
										<div class="product-img">
											<img src="<?= ($row['id'] == 9) ? './img/productacc04.png' : $row['gambar']; ?>" alt="">
											<div class="product-label">
												<?php if($row['is_sale']) echo '<span class="sale">-30%</span>'; ?>
												<?php if($row['is_new']) echo '<span class="new">NEW</span>'; ?>
											</div>
